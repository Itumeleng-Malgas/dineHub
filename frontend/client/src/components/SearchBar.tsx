...
const SearchBar: React.FC<SearchBarProps> = ({ onSearch }) => {
  ...
  // Fetches restaurants from the server when the component mounts
  useEffect(() => {
    if (selectedCountry) {
  ...
  // Fetch cities of the selected state when the component mounts
  useEffect(() => {
    if (selectedState) {
  ...
  setRestaurants(filteredRestaurants); // Update the state with filtered restaurants

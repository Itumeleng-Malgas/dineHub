...
import HeaderComponent from '@/components/adminPanel/Header';
import FooterComponent from '@/components/adminPanel/Footer';

import MenuComponent from '@/components/adminPanel/Menu';
import { usePathname } from 'next/navigation';
import { PageHeader } from '@/app/(adminPanel)/admin/_components/PageHeader';
    ...
    <Layout style={{ minHeight: '100vh', background: "#fff" }}>
      ...
      <ToggleProvider>
        ...
        <Content className='p-2 md:p-5'>
          <PageHeader>{pathname}</PageHeader>
          {children}
        </Content>
